...
module EasyTranscribe
  module UI
    module Detail
      ...
      def self.create_footer
        ...
        box.instance_eval do
          ...
          @buttons = Detail.create_footer_items
        end
      ...
      def self.create_toolbar
        ...
        tb.instance_eval do
          @items = Detail.create_toolbar_items.freeze
    ...
    def self.setup(opts = {})
      ...
      widgets = Detail.create_main_window_widgets

      win = Detail.create_window
      win.add(widgets[:layout])
      win.add_accel_group(Detail.create_toolbar_accelerators(widgets[:toolbar].buttons))
      win.show_all

      Detail.bind_commands(widgets[:toolbar].buttons, opts[:commands])
      Detail.bind_commands(widgets[:footer].buttons, opts[:commands])
